...
export default function DeveloperCampaigns() {
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-teal-100">Create and manage social media campaigns for your projects</p>
            </div>
            <button
              onClick={() => navigate('/developer/campaigns/create')}
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
            ...
            <p className="text-gray-600 mb-6">
              {campaigns.length === 0
                ? 'Create your first campaign to start promoting your projects on social media'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCampaigns.map((campaign) => (
              <CampaignCard
                key={campaign.id}
                campaign={campaign}
                onView={(c) => navigate(`/developer/campaigns/${c.id}`)}
                onEdit={(c) => navigate(`/developer/campaigns/${c.id}/edit`)}
